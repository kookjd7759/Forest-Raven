...
def getGameexeFile():
    return os.getcwd() + '\\Chess\\game\\build\\Debug\\game.exe'
### Path end
...
### Load
    def load_img(self):
        self.img_board = getImgFolder() + 'Ground.png'
        self.img_bq = getImgFolder() + 'bq.png'
        self.img_bk = getImgFolder() + 'bk.png'
        self.img_bb = getImgFolder() + 'bb.png'
        self.img_bn = getImgFolder() + 'bn.png'
        self.img_bp = getImgFolder() + 'bp.png'
        self.img_br = getImgFolder() + 'br.png'
        
        self.img_wq = getImgFolder() + 'wq.png'
        self.img_wk = getImgFolder() + 'wk.png'
        self.img_wb = getImgFolder() + 'wb.png'
        self.img_wn = getImgFolder() + 'wn.png'
        self.img_wp = getImgFolder() + 'wp.png'
        self.img_wr = getImgFolder() + 'wr.png'
